...
#	puts "#{birth_path}" #used for debugging
	return birth_path
end
...
date_of_birth = gets.strip.to_s
birth_path_number = determine_users_birth_path(date_of_birth)
#puts "#{birth_path_number}" #used for debugging
birth_message = determine_birth_message(birth_path_number)
puts "Your birth path number is: #{birth_path_number}. This means... #{birth_message}"